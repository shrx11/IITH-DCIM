...
ORGANIZATION_MENU = Menu(
    ...
    groups=(
        MenuGroup(
            ...
            items=(
                get_model_item('dcim', 'site', _('Labs')),
                # get_model_item('dcim', 'region', _('Regions')),
                get_model_item('dcim', 'sitegroup', _('Departments')),
        ...
        MenuGroup(
            label=_('Tenancy'),
            items=(
                get_model_item('tenancy', 'tenant', _('Users')),
                get_model_item('tenancy', 'tenantgroup', _('User Groups')),
            ),
        ),
        MenuGroup(
            label=_('Contacts'),
