...
urlpatterns = [
    ...
    # Site groups
    path('departments/', views.SiteGroupListView.as_view(), name='sitegroup_list'),
    path('departments/add/', views.SiteGroupEditView.as_view(), name='sitegroup_add'),
    path('departments/import/', views.SiteGroupBulkImportView.as_view(), name='sitegroup_import'),
    path('departments/edit/', views.SiteGroupBulkEditView.as_view(), name='sitegroup_bulk_edit'),
    path('departments/delete/', views.SiteGroupBulkDeleteView.as_view(), name='sitegroup_bulk_delete'),
    path('departments/<int:pk>/', include(get_model_urls('dcim', 'sitegroup'))),

    # Sites
    path('labs/', views.SiteListView.as_view(), name='site_list'),
    path('labs/add/', views.SiteEditView.as_view(), name='site_add'),
    path('labs/import/', views.SiteBulkImportView.as_view(), name='site_import'),
    path('labs/edit/', views.SiteBulkEditView.as_view(), name='site_bulk_edit'),
    path('labs/delete/', views.SiteBulkDeleteView.as_view(), name='site_bulk_delete'),
    path('labs/<int:pk>/', include(get_model_urls('dcim', 'site'))),
